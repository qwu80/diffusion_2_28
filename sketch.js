...
if (real_graph ==1){
      ...
      // }
      if (x_con>750) {
        triangle((10+100+70+change_square+940-change_length-70-760-20)*s_x, (171.2-concentration*0.7)*s_y, (170+x_con)*s_x, 171.25*s_y, (170+x_con)*s_x, (171.25-y_con)*s_y)
      }
...
// if (count_graph ==0){
        ...
        if (x_con<750) {
          ...
          rect(170*s_x,298.75*s_y,(x_con)*s_x,((test_a/x_con)-y_con_2)*s_y)
          // console.log(((test_a/x_con)-y_con_2)*s_y)
        }
...
switch_eh_1 = () => {
  if(switch_1 == 0){
    ...
    switch_1 = 1;
    switch_eh_1.checked = true
    switch_eh_2.checked = true
    switch_eh_3.checked = true
    switch_eh_4.checked = true
    switch_eh_5.checked = true
    console.log("sss")
  ...
  array_graph_con.push(new Concentration(scattering_velocity,scattering_count))
    ...
    switch_eh_2.checked = false
    switch_eh_3.checked = false
    switch_eh_4.checked = false
    switch_eh_5.checked = false
...
setTemperature_real = (te) => {
  ...
  document.getElementById("speed_3").value=(Math.pow(Math.pow(2.6,2)*Math.pow(10,10)*constant_temperature_real/300,1/2)).toExponential(1)
  document.getElementById("speed_4").value=Math.round(150*Math.pow((constant_temperature_real/300),-2.3)) //scarer
...
genBalls_scene1 = (num) =>{
  ...
  // generate *num* balls
if (loopp = true && sceneCount ==0.55 ||sceneCount ==0.555|| sceneCount ==0.5|| sceneCount ==0.7|| sceneCount ==0.71  || sceneCount ==1  || sceneCount ==2 || sceneCount ==3|| sceneCount ==3.1 && whiteArray.length<13000) {
...
if (box_count.length < concentration) {
  ...
  if (sceneCount ==0.55 ||sceneCount ==0.555 ){
    for (let i=0; i < num; i ++){
...
if (box_count_h.length < concentration) {
if (switch_1 ==2) {
